        ...
        <div class="row">
            <div class="container-fluid text-center">
                ...
                <div class="col-md-6">
                    ...
                    <a href="?r=site/manempresa">
                        <button class="btn btn-default manem" style="position: relative;top: -227px;right: -149px;">Mantenimiento empresa.</button>
                    </a>
                </div>
            </div>
        </div>
